...
export const ElementEditorReset = (element) => ({
    type: ActionTypes.EDITOR.ELEMENT_RESET,
    payload: {element}
});
...
export const ElementLikelihoodEdit = (likelihood) => ({
    type: ActionTypes.EDITOR.ELEMENT_LIKELIHOOD_EDIT,
    payload: { likelihood }
});

export const ElementLikelihoodEdit2 = (likelihood2) => ({
    type: ActionTypes.EDITOR.ELEMENT_LIKELIHOOD2_EDIT,
    payload: { likelihood2 }
});

export const ElementLikelihoodEdit3 = (likelihood3) => ({
    type: ActionTypes.EDITOR.ELEMENT_LIKELIHOOD3_EDIT,
    payload: { likelihood3 }
});

export const ElementYears = (years) => ({
    type: ActionTypes.EDITOR.ELEMENT_YEARS_EDIT,
    payload: { years }
});

export const ElementCalculation = (isProb) =>({
    type: ActionTypes.EDITOR.ELEMENT_CALCULATION_EDIT,
    payload: { isProb }
});
...
export const ElementChangeRelation = (i) => ({
    type: ActionTypes.EDITOR.ELEMENT_CHANGE_RELATION,
    payload: { i }
});
